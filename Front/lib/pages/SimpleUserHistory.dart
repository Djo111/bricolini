...
class _SimpleUhistoryState extends State<SimpleUhistory> {
  List<Offer> history_list=[Offer(photo: "../../assets/Logo_Arcturus.png", title: "Ahmed", address: "Charguiya", price: 100, type: "Wood"),
    Offer(photo: "../../assets/Logo_Arcturus.png", title: "Hamiiid", address: "Tunis, Tunisie", price: 100, type: "Wood")];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('History', style: TextStyle(color: Colors.lightGreen, fontSize: 20),),
