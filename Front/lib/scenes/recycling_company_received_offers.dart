      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 16.0), // Add horizontal padding here
              child: Container(
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius:
                      BorderRadius.circular(8.0), // Adjust the image border radius as needed.
                    ),
                    child: ClipRRect(
                      // Use ClipRRect to apply borderRadius to the image
                      borderRadius:
                      BorderRadius.circular(6.0), // Adjust the image border radius as needed.
                      child: Image.asset(
                        offer.photo,
                        width: 72,
                        height: 90,
